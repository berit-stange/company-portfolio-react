    ...
    return (
        <div className="main">
            <div className="grid-container-article">
                ...
                <div className="image-medium grid-box-a">A
                    {/* <img src={paperlove1}></img> */}
                </div>
                <div className="image-medium grid-box-a">B</div>
                <div className="image-medium grid-box-a">C</div>
                <div className="image-medium grid-box-a">D</div>
